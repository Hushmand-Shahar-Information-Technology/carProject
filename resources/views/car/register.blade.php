        ...
        <div x-data="carForm()" x-init="initSelect2(); watchProgress()" x-effect="watchProgress()">
            ...
            <div x-show="step === 1" class="space-y-4">
                <div>
                    ...
                    <input type="text" x-model="form.title" class="w-full border rounded p-2 title-input @error('title') border-red-500 @enderror" placeholder="Title of the car" name="title" " />
                    @error('title')
