                ...
                <div class="owl-carousel" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="1"
                    ...
                    <div class="item">
                        <div class="testimonial-block text-center">
                            <div class="testimonial-image">
                                <img class="img-fluid" src="{{ asset('images/testimonial/08.jpg') }}" alt="">
                            </div>
                            <div class="testimonial-box">
                                <div class="testimonial-avtar">
                                    <img class="img-fluid" src="{{ asset('images/testimonial/09.jpg') }}"
                                        alt="">
                                    <h6>Muhammad Hakeem Wiyar</h6>
                    ...
                    <div class="item">
                        <div class="testimonial-block text-center">
                            ...
                            <div class="testimonial-box">
                                <div class="testimonial-avtar">
                                    <img class="img-fluid" src="{{ asset('images/testimonial/10.jpg') }}"
                                        alt="">
                                    <h6>Ozair Khurami</h6>
                    ...
                    <div class="item">
                        <div class="testimonial-block text-center">
                            <div class="testimonial-image">
                                <img class="img-fluid" src="{{ asset('images/testimonial/09.jpg') }}" alt="">
                            </div>
                            <div class="testimonial-box">
                                <div class="testimonial-avtar">
                                    <img class="img-fluid" src="{{ asset('images/testimonial/10.jpg') }}"
                                        alt="">
                                    <h6>Abdul Wali Aryan</h6>
                                    <span>Auto Dealer</span>
                                </div>
                                <div class="testimonial-content">
