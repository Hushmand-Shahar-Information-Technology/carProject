...
>
    <div
        ...
        x-ignore
    >
        <div class="relative w-full mx-auto rounded-lg overflow-hidden shadow bg-gray-50">
            <div
                x-ref="mapContainer"
            ...
            <div class="p-4 bg-gray-50 border-t border-gray-200" x-show="lat !== null && lng !== null">
                        ...
                        <template x-for="(result, index) in localSearchResults" :key="index">
                            <li class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                >
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-800" x-text="result.display_name || result.name"></p>
                                    </div>
                                </button>
                            </li>
                        </template>
